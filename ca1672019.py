...
eventLog_ca116 = pd.read_csv(basePath + 'ca167_eventLog_nonfixed_2019.csv')
...
materialAccessedByWeek.to_csv(basePath + 'materialAccessedByWeek_ca167_2019.csv')
...
dataUpload = pd.read_csv(basePath + 'ca167_uploads_2019.csv')
