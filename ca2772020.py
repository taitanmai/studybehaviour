...
eventLog_ca116 = pd.read_csv(basePath + 'ca277_eventLog_nonfixed_2020.csv')
...
materialAccessedByWeek.to_csv(basePath + 'materialAccessedByWeek_ca277_2020.csv')

materialAccessedByWeek = pd.read_csv(basePath + 'materialAccessedByWeek_ca277_2020.csv', index_col=0)
...
dataUpload = pd.read_csv(basePath + 'ca277_uploads_2020.csv')
...
ex3_excellent.to_csv(basePath + 'ca2772020_ex3_excellent.csv',index=True)
ex3_weak.to_csv(basePath + 'ca2772020_ex3_weak.csv',index=True)
