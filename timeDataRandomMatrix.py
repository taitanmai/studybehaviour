...
for w in range(0,12):
    transitionDataMatrixWeeks.append(pd.read_csv('transitionMatrixStorage/transitionDataMatrixWeeks_time_eventually_w'+str(w)+'.csv', header=0,index_col=0))
...
for w in range(0,12):
    for algorithm in prediction_transition1[w]:
        if algorithm != 'data':
            reportArray_transition.append([w,algorithm, 
                                  prediction_transition1[w][algorithm][0]['accuracy_score'][0],
                                  prediction_transition1[w][algorithm][0]['f1_score'][0],
                                  prediction_transition1[w][algorithm][0]['precision_score'][0],
                                  prediction_transition1[w][algorithm][0]['recall_score'][0],
                                  prediction_transition1[w][algorithm][0]['roc_auc'],
                                  prediction_transition1[w][algorithm][4].mean()
                                  ])
...
selectedBestResult.to_csv('BestResultScore_timeData.csv',index=False)
#RMT Classified
